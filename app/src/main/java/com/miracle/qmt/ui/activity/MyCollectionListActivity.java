 ...
 */
public class MyCollectionListActivity extends BaseListActivity<BasePresenter, NewsItem, ArrayList<NewsItem>> {
    ...
    public Observable<MyResult<ArrayList<NewsItem>>> getObservble() {
        return ApiFactory.getXynSingleton().mycollection(AppController.getInstance().getUser().getUser_id()+"");
    }
