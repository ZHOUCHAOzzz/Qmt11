package com.miracle.qmt.util.location;
...
import com.miracle.qmt.util.baidu.LocationService;
...
public class Activity01 extends BaseActivity implements OnScrollListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        personList.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view,
                ...
                if (position >= 4) {
                    String name = allCity_lists.get(position).getName();
        ...
        resultList.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view,
                ...
                String name = city_result.get(position).getName();
                T.showShort(getApplicationContext(), name);
                Intent intent = getIntent();
                intent.putExtra(NAME, name);
                setResult(10002,intent);
                finish();
...
//        locationService = ((AppController) getApplication()).locationService;
    ...
    /*****
     * @see //定位结果回调，重写onReceiveLocation方法，可以直接拷贝如下代码到自己工程中修改
     */
    private BDLocationListener mListener = new BDLocationListener() {

        @Override
        public void onReceiveLocation(BDLocation location) {
            Logger.d("activity 1 location recive");
            if (null != location && location.getLocType() != BDLocation.TypeServerError) {
                PreferencesUtils.setPreferences(Activity01.this, PreferencesUtils.LATITUDE, location.getLatitude() + "");
                PreferencesUtils.setPreferences(Activity01.this, PreferencesUtils.LONTITUDE, location.getLongitude() + "");
//				mTvTitle.setText(location.getCity());
                ...
                runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
                        tv_noresult.setText(currentCity);
                        personList.setAdapter(adapter);
                        if(adapter != null)
    ...
    public class ListAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (viewType == 0) { // 定位
                convertView = inflater.inflate(R.layout.location_frist_list_item, null);
                ...
                convertView = inflater.inflate(R.layout.location_recent_city, null);
                ...
                rencentCity.setOnItemClickListener(new OnItemClickListener() {
                    ...
                    public void onItemClick(AdapterView<?> parent, View view,
                        ...
                        String name = city_history.get(position);
                        Toast.makeText(getApplicationContext(), name, Toast.LENGTH_SHORT).show();
                        Intent intent = getIntent();
                        intent.putExtra(NAME, name);
                        setResult(10002,intent);
                ...
                hotCity.setOnItemClickListener(new OnItemClickListener() {
                    ...
                    public void onItemClick(AdapterView<?> parent, View view,
                        ...
                        String name = city_hot.get(position).getName();
                        Toast.makeText(getApplicationContext(), name, Toast.LENGTH_SHORT).show();
                        Intent intent = getIntent();
                        intent.putExtra(NAME, name);
                        setResult(10002,intent);
                ...
                convertView = inflater.inflate(R.layout.location_total_item, null);
            } else {
                if (convertView == null) {
                    convertView = inflater.inflate(R.layout.location_list_item, null);
    ...
    class HotCityAdapter extends BaseAdapter {
        ...
        @Override
        public View getView(int position, View convertView, ViewGroup parent) {
            convertView = inflater.inflate(R.layout.location_item_city, null);
